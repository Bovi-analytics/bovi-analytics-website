...
-   One of the most important cloud-based tools you probably will use is Databricks. The platform allows you to perform data science in the cloud, and especially work together easily across the team.
    ...
    -   Start by trying it using the following guide =\> [Community Edition of Databricks](https://bovi-analytics.org/tutorials/databricks.html)
...
One of the very popular visualization tools we use is <http://tableau.com>. You can get a version of it using this tutorial (<https://bovi-analytics.org/tutorials/tableau.html> )!
...
-   Because of that
    ...
    -   Within everything you do, start applying a naming convention as soon as possible (See here <https://bovi-analytics.org/tutorials/general-naming-convention.html> ). Within your programming work, I can imagine you want to follow the guidelines within the programming language.
